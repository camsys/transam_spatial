...
RSpec.describe GoogleGeocodingService do
  ...
  it 'reverse_search' do # Sometimes will fail giving a slightly different address format for the same location
    expect(test_service.send(:process_results, test_service.send(:reverse_search, [42.401721, -71.081997]))).to eq("101 Station Landing, 101 Station Landing, Medford, MA 02155").or eq("Fourth Floor, 101 Station Landing, Medford, MA 02155, United States").or eq("15 Presidents Landing, Medford, MA 02155")
  end
