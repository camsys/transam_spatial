...
ActiveRecord::Schema.define(version: 2018_11_16_174415) do
  ...
  create_table "map_overlay_service_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "code"
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "map_overlay_services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
